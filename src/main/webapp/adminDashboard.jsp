...
<body>
    ...
    <h2>Welcome To FarmTrak Admin</h2>

    <div id="form-container">
        <form method="post" action="adminDashboard.jsp" onsubmit="return redirectToNavigation();">
            I am a :
    ...
    <script>
        ...
        function redirectToNavigation() {
            ...
            if (userType === "admin" && username === "admin@example.com" && password === "admin123") {
                window.location.href = 'adminDashboard.jsp';
                return true;
            }
            // Buyer and Farmer credentials validation
            else if ((userType === "buyer" && username === "buyer1@example.com" && password === "buyer123") || 
                     (userType === "farmer" && username === "farmer1@example.com" && password === "farmer123")) {
